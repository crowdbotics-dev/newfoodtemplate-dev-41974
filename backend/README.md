...
## Project Structure
    ...
    ├── newfoodtemplate_dev_41974  # Django project configurations
...
1. Clone this repo and `cd newfoodtemplate_dev_41974`
...
2. Clone this repo and `cd newfoodtemplate_dev_41974`
